...
class MonthlyCalendarScreen(Screen):
    ...
    def _render_calendar(self) -> None:
        ...
        lines.append(self._colorize(header.center(40), f"bold {self.palette.accent_high}"))
        lines.append("")
        ...
        lines.append(self._colorize("─" * 40, self.palette.text_muted))
        ...
        month_entries = [
            entry for day_date, entry in self.moods_by_date.items()
        ...
        if month_entries:
            ...
            lines.append(self._colorize(stats.center(40), self.palette.accent_low))
        else:
            lines.append(self._colorize("No entries this month".center(40), self.palette.text_muted))
